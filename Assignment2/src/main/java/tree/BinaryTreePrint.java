...
public class BinaryTreePrint {
	...
	/*
	 * This method requires that there is a class tree.BinaryTreeNode
	 ...
	 * tree.BinaryTreeNode getLeftChild()) // return a reference to leftChild
	 * tree.BinaryTreeNode getRightChild()) // return a reference to rightChild
	 * 
